	...
	function get_crumbs( $sep, $l10n, $args ){
		...
		if(1){
			...
			elseif( $mark === 'rdf.data-vocabulary.org' ) $mark = array(
				'wrappatt'   => '<ol class="breadcrumb" prefix="v: http://rdf.data-vocabulary.org/#">%s</ol>',
				'linkpatt'   => '<span typeof="v:Breadcrumb"><a href="%s" rel="v:url" property="v:title">%s</a>',
				'sep_after'  => '</span>', // закрываем span после разделителя!
			);
			// schema.org
			elseif( $mark === 'schema.org' ) $mark = array(
				'wrappatt'   => '<ol class="breadcrumb" itemscope itemtype="http://schema.org/BreadcrumbList">%s</ol>',
				'linkpatt'   => '<li itemscope itemtype="http://schema.org/ListItem"><a href="%s" itemprop="item"><span itemprop="name">%s</span></a></li>',
				'sep_after'  => '',
			);
